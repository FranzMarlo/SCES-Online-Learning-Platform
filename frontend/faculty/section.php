                        ...
                        <?php if ($sections): ?>
                                <?php foreach ($sections as $section): ?>
                                        <div class="section-item" data-section-year="<?php echo htmlspecialchars($section['year']); ?>"
                                            ...
                                            <a href="/SCES/frontend/faculty/student-section?section=<?php echo $section['section_id']; ?>"
                                                class="hidden-link"></a>
                        ...
                        <?php if ($archived): ?>
                                <?php foreach ($archived as $archive): ?>
                                        <div class="section-item" data-section-year="<?php echo htmlspecialchars($archive['year']); ?>"
                                            ...
                                            <a href="/SCES/frontend/admin/student-section?section=<?php echo $archive['section_id']; ?>"
                                                class="hidden-link"></a>
