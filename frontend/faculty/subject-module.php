...
include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/subject-head.php';
              ...
              <?php if ($lessons): ?>
                <?php foreach ($lessons as $lesson): ?>
                  <div class="lesson-item <?php echo strtolower($subject['subject_code']); ?>-item">
                    ...
                    <a href="/frontend/faculty/view-lesson.php?pdf=<?php echo urlencode($lesson['pdf_file']); ?>&lesson_number=<?php echo urlencode($lesson['lesson_number']); ?>&subject_id=<?php echo urlencode($lesson['subject_id']); ?>"
...
<?php
include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/faculty-add-lesson.php';
include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/view-students-modal.php';
...
<script src="/assets/script/faculty-lesson.js"></script>