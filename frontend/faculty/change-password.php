<?php
include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/head.php';
include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/password-head.php';
?>
...
<body>
        ...
        <div class="max-content">
            <div class="flex-container">
                <div class="column left">
                    ...
                    <div class="wrapper">
                        <img src="/assets/images/admin-signup.png" alt="sign up icon" />
                    </div>
                </div>
    ...
    <?php else: ?>
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/page-error.php'; ?>
    <?php endif; ?>
    <?php
    include $_SERVER['DOCUMENT_ROOT'] . '/frontend/faculty/partials/footer.php';
    ?>