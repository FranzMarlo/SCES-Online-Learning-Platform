        ...
        <div class="menu">
            <ul>
                <li class="<?= $current_page == 'dashboard' ? 'active' : '' ?>">
                    <a href="/SCES/frontend/faculty/dashboard">
                        <i class="fa-solid fa-house icon"></i>
                        <span class="text">Home</span>
                    </a>
                </li>
                <li class="<?= $current_page == 'profile' ? 'active' : '' ?>">
                    <a href="/SCES/frontend/faculty/profile">
                ...
                <li
                    class="<?= in_array($current_page, ['section', 'student-list', 'student-section']) ? 'active' : '' ?>">
                    <a href="javascript:void(0)">
                ...
                <li class="<?= $current_page == 'analytics' ? 'active' : '' ?>">
                    <a href="/SCES/frontend/faculty/analytics">
                        <i class="fa-solid fa-chart-simple icon"></i>
                        <span class="text">Analytics</span>
                    </a>
                </li>
                <li class="<?= $current_page == 'settings' ? 'active' : '' ?>">
                    <a href="/SCES/frontend/faculty/settings">
                        <i class="fa-solid fa-gear icon"></i>
                        <span class="text">Settings</span>
                    </a>
                </li>
                <li class="<?= $current_page == 'help' ? 'active' : '' ?>">
                    <a href="/SCES/frontend/faculty/help">
