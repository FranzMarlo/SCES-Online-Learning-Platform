...
include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/password-head.php';
?>
...
<body>
        ...
        <div class="max-content">
            <div class="flex-container">
                <div class="column left">
                    ...
                    <div class="wrapper">
                        <img src="/assets/images/signup-admin.png" alt="sign up icon" />
                    </div>
                </div>
    ...
    <?php else: ?>
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/page-error.php'; ?>
    <?php endif; ?>
    <?php
