...
$page = '';
?>
<link rel="stylesheet" href="/assets/style/admin-student-list.css" />
...
<body>
    ...
    <?php
    include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/student-list-modal.php';
    ...
    <script src="/assets/script/admin-student-list.js"></script>