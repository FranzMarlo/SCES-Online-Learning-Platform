...
$page = '';
?>
<link rel="stylesheet" href="/assets/style/faculty-list.css" />
...
<body>
    ...
    <?php
    include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/view-faculty-modal.php';
    ...
    <script src="/assets/script/faculty-list.js"></script>