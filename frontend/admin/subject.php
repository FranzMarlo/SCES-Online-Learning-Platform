                        ...
                        <?php if ($subjects): ?>
                                <?php foreach ($subjects as $subject): ?>
                                        <div class="subject-item"
                                            ...
                                            <a href="/SCES/frontend/admin/subject-module?section=<?php echo urlencode($subject['section_id']); ?>&subject=<?php echo urlencode($subject['subject_id']); ?>&gradelevel=<?php echo urlencode($subject['level_id']); ?>&teacher=<?php echo urlencode($subject['teacher_id']); ?>"
                                                class="hidden-link"></a>
                        ...
                        <?php if ($archived): ?>
                                <?php foreach ($archived as $archive): ?>
                                        <div class="subject-item"
                                            ...
                                            <a href="/SCES/frontend/admin/subject-module?section=<?php echo urlencode($archive['section_id']); ?>&subject=<?php echo urlencode($archive['subject_id']); ?>&gradelevel=<?php echo urlencode($archive['level_id']); ?>&teacher=<?php echo urlencode($archive['teacher_id']); ?>"
                                                class="hidden-link"></a>
