...
$page = '';
?>
<link rel="stylesheet" href="/assets/style/admin-subject.css" />
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="total-container">
                <div class="item">
                    <div class="item-icon">
                        <img src="/assets/images/subject-students.png" alt="total students icon">
                    </div>
                    <div class="item-text">
                ...
                <div class="item">
                    <div class="item-icon">
                        <img src="/assets/images/subject-lessons.png" alt="total lessons icon">
                    </div>
                    <div class="item-text">
                ...
                <div class="item">
                    <div class="item-icon">
                        <img src="/assets/images/subject-archived.png" alt="total archived icon">
                    </div>
                    <div class="item-text">
        ...
        <script src="/assets/script/search-filter.js"></script>
        <?php
        include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/subject-modal.php';
        include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/admin-footer.php';
        ?>
        <script src="/assets/script/admin-subject.js"></script>