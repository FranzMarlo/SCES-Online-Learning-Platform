...
$page = '';
?>
<link rel="stylesheet" href="/assets/style/admin-section.css" />
...
<body>
    ...
    <div class="container">
            ...
            <div class="section-panel">
                <div class="panel-title">
                    <div class="title-part">
                        <img src="/assets/images/quiz-grade-section.png" alt="section icon">
                        <h1>Sections</h1>
                    </div>
        ...
        <?php
        include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/section-modal.php';
        include $_SERVER['DOCUMENT_ROOT'] . '/frontend/admin/partials/admin-footer.php';
        ?>
        <script src="/assets/script/admin-section.js"></script>